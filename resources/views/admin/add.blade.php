@extends('layouts.app', ['activePage' => 'adminadd', 'titlePage' => __('adminadd')])
        ...
        <div class="col-md-12">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                @endif
                <form method="POST" action="/admin/insert" autocomplete="off" class="form-horizontal">
                  @csrf
                <div class="row">
                ...
                <div class="row">
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="password" id="input-email" type="text" placeholder="{{ __('Password') }}" required />
